...
export const MOTH_CONFIG = {
  ...
  approachSlowRadius: 0.86,
  turnLerp: 0.070,
  turnLerpFast: 0.095,
  headingTargetBlend: 0.10,
  headingVelocityBlend: 0.90,
  turnResponse: 3.05,
  turnResponseFast: 4.25,
  headingVelocityMin: 0.075,
  headingMinSpeed: 0.10,
  headingDeadzone: 0.060,
  headingSmoothing: 2.85,
  velocityResponse: 2.85,
  velocityResponseFast: 3.75,
  ...
  velocityFacingMinSpeed: 0.070,
  velocityHeadingBlendMin: 0.010,
  velocityHeadingBlendMax: 0.105,
  turnAlphaMax: 0.130,
  noYawStutterMode: true,
  orientationFreezeSpeed: 0.060,
  orientationFreezeDistance: 0.095,
  orientationMaxTurnDegreesPerSecond: 34,
  orientationMaxTurnFastDegreesPerSecond: 48,
  velocitySteeringMaxTurnDegreesPerSecond: 68,
  ...
  homePerchApproachSpeedScale: 0.72,
  ...
  investigateCoverDuration: 1.65,
  investigateCoverRadius: 0.14,
  investigateCoverSpeed: 1.05,
  perchEdgeWalk: 0.055,
  shelterCoverIndex: 0,
